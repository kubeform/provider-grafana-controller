module kubeform.dev/provider-grafana-controller
...
require (
	...
	github.com/grafana/grafana-api-golang-client v0.4.0 // indirect
	github.com/grafana/machine-learning-go-client v0.1.1 // indirect
	github.com/grafana/synthetic-monitoring-agent v0.6.2 // indirect
	github.com/grafana/synthetic-monitoring-api-go-client v0.5.1 // indirect
