...
func (in *MonitoringCheckSpecSettings) DeepCopyInto(out *MonitoringCheckSpecSettings) {
	*out = *in
	...
	if in.Traceroute != nil {
		...
		*out = new(MonitoringCheckSpecSettingsTraceroute)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MonitoringCheckSpecSettingsTraceroute) DeepCopyInto(out *MonitoringCheckSpecSettingsTraceroute) {
	*out = *in
	if in.MaxHops != nil {
...
func (in *MonitoringCheckSpecSettingsTraceroute) DeepCopy() *MonitoringCheckSpecSettingsTraceroute {
	if in == nil {
		return nil
	}
	out := new(MonitoringCheckSpecSettingsTraceroute)
