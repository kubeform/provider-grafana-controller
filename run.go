...
import (
	...
	grafanascheme "kubeform.dev/provider-grafana-api/client/clientset/versioned/scheme"
...
func init() {
	_ = grafanascheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform grafana Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-grafana-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "grafana.kubeform.com",
			})
			if err != nil {
