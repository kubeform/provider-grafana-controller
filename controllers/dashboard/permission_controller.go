...
// +kubebuilder:rbac:groups=dashboard.grafana.kubeform.com,resources=permissions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dashboard.grafana.kubeform.com,resources=permissions/status,verbs=get;update;patch
...
func (r *PermissionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dashboardv1alpha1.Permission{}); err != nil {
			klog.Error(err, "unable to set up auditor", dashboardv1alpha1.Permission{}.APIVersion, dashboardv1alpha1.Permission{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dashboardv1alpha1.Permission{}).
