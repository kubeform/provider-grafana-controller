...
// +kubebuilder:rbac:groups=cloud.grafana.kubeform.com,resources=stacks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloud.grafana.kubeform.com,resources=stacks/status,verbs=get;update;patch
...
func (r *StackReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudv1alpha1.Stack{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudv1alpha1.Stack{}.APIVersion, cloudv1alpha1.Stack{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudv1alpha1.Stack{}).
