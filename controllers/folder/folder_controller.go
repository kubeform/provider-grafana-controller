...
// +kubebuilder:rbac:groups=folder.grafana.kubeform.com,resources=folders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=folder.grafana.kubeform.com,resources=folders/status,verbs=get;update;patch
