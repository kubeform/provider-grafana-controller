...
// +kubebuilder:rbac:groups=organization.grafana.kubeform.com,resources=organizations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=organization.grafana.kubeform.com,resources=organizations/status,verbs=get;update;patch
