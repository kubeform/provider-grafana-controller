...
// +kubebuilder:rbac:groups=data.grafana.kubeform.com,resources=sources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=data.grafana.kubeform.com,resources=sources/status,verbs=get;update;patch
...
func (r *SourceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datav1alpha1.Source{}); err != nil {
			klog.Error(err, "unable to set up auditor", datav1alpha1.Source{}.APIVersion, datav1alpha1.Source{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datav1alpha1.Source{}).
...
func (r *SourceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Source")
			return nil
		}
		...
		resourceList := &datav1alpha1.SourceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Source")
			return nil
		}
