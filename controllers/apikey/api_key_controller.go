...
// +kubebuilder:rbac:groups=apikey.grafana.kubeform.com,resources=apikeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apikey.grafana.kubeform.com,resources=apikeys/status,verbs=get;update;patch
