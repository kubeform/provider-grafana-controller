...
// +kubebuilder:rbac:groups=team.grafana.kubeform.com,resources=teams,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=team.grafana.kubeform.com,resources=teams/status,verbs=get;update;patch
