...
// +kubebuilder:rbac:groups=report.grafana.kubeform.com,resources=reports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=report.grafana.kubeform.com,resources=reports/status,verbs=get;update;patch
...
func (r *ReportReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &reportv1alpha1.Report{}); err != nil {
			klog.Error(err, "unable to set up auditor", reportv1alpha1.Report{}.APIVersion, reportv1alpha1.Report{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&reportv1alpha1.Report{}).
