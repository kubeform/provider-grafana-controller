...
// +kubebuilder:rbac:groups=role.grafana.kubeform.com,resources=roles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=role.grafana.kubeform.com,resources=roles/status,verbs=get;update;patch
